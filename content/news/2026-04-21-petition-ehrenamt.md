title: Petition, recognition of open-source work
...
It is always a challenge to find and keep contributors. Official recognition would make it easier for people to justify the time they spend on Mixxx. It shows that writing code for the community is just as valuable as any other social work. As a registered non-profit, we want to support our developers with the same respect other volunteers receive.
...
[Please sign the petition here](https://www.openpetition.de/petition/online/anerkennung-von-open-source-arbeit-als-ehrenamt-in-deutschland)
(Even if you are not from Germany, your support helps show the global impact of this issue!)
