...
* 10 x [Mixxx 25th anniversary T-Shirts (1 for each finalist)](https://shop.mixxx.org/)  
* even more prizes will appear on the table during the contest  
...
We apologize if our communication did not reach you or was lost. You can still add a prize / prizes to our prize table; please contact us at 25years@mixxx.org for this. We greatly appreciate your support.

**Prizes cannot be exchanged for cash, prizes are shipped from Germany; although everyone can participate, participants from certain countries may not be able to choose and receive a prize if no customs agreements exist between the participant's country and the European Union.**

**You must use Mixxx. You can use any version, including your own custom build (e.g. Mixxx 2.5.4 with extra features).**


## Round 1 – Open to everyone (maximum 100)

* Prepare a set of **maximum 6 minutes** and practice it. (setvideos with a duration of maximum 6:10 are accepted)
* Your set must contain **2 samples** that are clearly audible and recognizable **3 times**:
    - "Mixxx", "Mix" ...
    - "25" (in English)
...
* **Video submission deadline:** December 2nd, 18:00 CET
* **Voting opens:** December 9th, 18:00 CET
...
* The timestamps where the required samples are audible  
    - in the example:
        ...
        - '25'-sample: 0:31, 1:54, 1:56 (2x), 2:03, 2:12, 4:18 (2x), 4:20 (2x), 4:23  
* The two tracks you used that differ by 25 years and 25 BPM
    - in the example:
...
* The controller you use (if applicable)
    - in the example: 2x Traktor Kontrol F1 (1 mapped to mixer faders, 1 for stems)  
* A few lines about yourself: your DJ history, interests, style, and musical preferences. Complete the following text and copy it to your participation email:

> (DJname), aka (firstname) (name) is a (age) years old DJ from (city), (country).  
(She/he/they ...) started (years) ago DJing and describes (her/his/their ..) style as (style).  
What (DJname) loves about DJing is ...  
...
| Round | Contesting DJ's | Votes | Video deadline | Voting starts | Voting ends |
|-------|-----------------|-------|----------------|---------------|-------------|
| 1st   | up to 100       | 5     | September 30th | October 7th   | October 18th |
|       |                 |       | (18:00 CET)    | (18:00 CET)   | (18:00 CET)  |
|       |                 |       |                |               |             |
| 2nd   | 25              | 3     | November 4th   | November 11th | November 22nd|
|       |                 |       | (18:00 CET)    | (18:00 CET)   | (18:00 CET)  |
|       |                 |       |                |               |             |
| Final | 10              | 1     | December 2nd   | December 9th  | December 20th|
|       |                 |       | (18:00 CET)    | (18:00 CET)   | (18:00 CET)  |
